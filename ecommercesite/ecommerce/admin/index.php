      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT * FROM order_master om LEFT JOIN book_master bm ON bm.book_id=om.book_id");
                $stmt->execute();
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT * FROM order_master LEFT JOIN order_id ON order_id=order_id LEFT JOIN book_master ON book_id=book_id WHERE order_date=:order_date");
