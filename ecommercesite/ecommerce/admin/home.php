      ...
      <div class="row">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              var_dump($srow);
               echo "</pre>";
              exit();*/
                $stmt = $conn->prepare("SELECT * FROM order_master om LEFT JOIN book_master bm ON om.book_id=bm.book_id");
                $stmt->execute();

                $total = 0;
                foreach($stmt as $srow){
                  $subtotal = $srow['book_price']*$srow['book_quantity'];
                  $total += $subtotal;
                }
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM book_master");
                $stmt->execute();
                $prow =  $stmt->fetch();
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM user_master");
                $stmt->execute();
                $urow =  $stmt->fetch();
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT * FROM order_master om LEFT JOIN book_master bm ON om.book_id=bm.book_id WHERE order_date=:order_date");
                $stmt->execute(['order_date'=>$today]);

                $total = 0;
                foreach($stmt as $trow){
                  $subtotal = $trow['order_price']*$trow['order_quantity'];
                  $total += $subtotal;
                }
