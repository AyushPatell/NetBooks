                    ...
                    <select class="form-control input-sm" id="select_category">
                      ...
                      <?php
                        ...
                        foreach($stmt as $crow){
                          ...
                          echo "
                            <option value='".$crow['cat_id']."' ".$selected.">".$crow['cat_name']."</option>
                          ";
                        }
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $now = date('Y-m-d');
                      $stmt = $conn->prepare("SELECT * FROM book_master $where");
                      $stmt->execute();
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
                              ...
                              <span class='pull-right'><a href='#edit_photo' class='photo' data-toggle='modal' data-id='".$row['book_id']."'><i class='fa fa-edit'></i></a></span>
                            </td>
                            <td><a href='#description' data-toggle='modal' class='btn btn-info btn-sm btn-flat desc' data-id='".$row['book_id']."'><i class='fa fa-search'></i> View</a></td>
